...
public class FakeData {
    ...
    public static void generateFakeUsers() {
        ...
        // Para o user1
        /*
        user1.donateABook(new Book(1, "Dom Casmurro", "Um romance brasileiro clássico", "Ficção", true, "https://firebasestorage.googleapis.com/v0/b/obes-app.appspot.com/o/1701317079150.jpg?alt=media&token=ee7f1597-2a26-403f-bd32-c5560b871c60", "Machado de Assis", 0.0, "Novo"));
        ...
        // Para o user2
        user2.sellABook(new Book(3, "1984", "Distopia futurista", "Ficção Científica", true, R.drawable.cover_book2, "George Orwell", 19.99, "Usado"));
        user2.sellABook(new Book(4, "A Menina que Roubava Livros", "História durante a Segunda Guerra Mundial", "Drama", true, R.drawable.cover_book1, "Markus Zusak", 15.99, "Novo"));
        user2.sellABook(new Book(5, "Harry Potter e a Pedra Filosofal", "A primeira aventura de Harry Potter", "Fantasia", true, R.drawable.cover_book2, "J.K. Rowling", 24.99, "Usado"));

        // Para o user3
        user3.sellABook(new Book(6, "Senhor dos Anéis", "Uma jornada épica de fantasia", "Fantasia", true, R.drawable.cover_book1, "J.R.R. Tolkien", 29.99, "Novo"));
        user3.sellABook(new Book(7, "O Código Da Vinci", "Uma trama de mistério e conspiração", "Mistério", true, R.drawable.cover_book2, "Dan Brown", 12.99, "Usado"));

        user3.donateABook(new Book(8, "O Diário de Anne Frank", "O relato de uma jovem durante o Holocausto", "Biografia", true, R.drawable.cover_book1, "Anne Frank", 0.0, "Usado"));
        user3.donateABook(new Book(9, "Cem Anos de Solidão", "Um épico da literatura latino-americana", "Ficção", true, R.drawable.cover_book2, "Gabriel García Márquez", 0.0, "Novo"));
        user3.donateABook(new Book(10, "A Revolução dos Bichos", "Uma alegoria política", "Fábula", true, R.drawable.cover_book1, "George Orwell", 0.0, "Usado"));
